...
class Module_privsep_Tests(t_utils.TestUtils):
    ...
    async def test_getFileChildren_Raises_BadArg(self):
        """
        ...
        async with self.getTestCoreWithPkg() as core:
            q = """
                ...
                $inp = $lib.null
                return($mod.getFileChildren($inp))
                """
    ...
    async def test_getFileChildren_Raises_NeedConfValu_for_no_api_host(self):
        """
    ...
    async def test_getFileChildren_Raises_NeedConfValu_for_no_api_creds(self):
        """
