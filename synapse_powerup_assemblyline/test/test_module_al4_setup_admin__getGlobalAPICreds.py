...
class Module_setup_admin_Tests(t_utils.TestUtils):
    async def test_getGlobalAPICreds(self):
        """
    ...
    async def test_getGlobalAPICreds_returns_null(self):
        """
    ...
    async def test_getGlobalAPICreds_raises_AuthDeny_noAsRootPerms(self):
        """
    ...
    async def test_getGlobalAPICreds_powerupUserInAdminGroup(self):
        """
