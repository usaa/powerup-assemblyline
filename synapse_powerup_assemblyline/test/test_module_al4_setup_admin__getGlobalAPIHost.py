...
class Module_setup_admin_Tests(t_utils.TestUtils):
    async def test_getGlobalAPIHost(self):
        """
    ...
    async def test_getGlobalAPIHost_returns_null(self):
        """
    ...
    async def test_getGlobalAPIHost_raises_AuthDeny_noAsRootPerms(self):
        """
    ...
    async def test_getGlobalAPIHost_powerupUserInAdminGroup(self):
        """
