...
class Module_ontology_v1x_Tests(t_utils.TestUtils):
    async def test_addStaticDomains_create(self):
        """
        Validate an inet:fqdn node is created.
        """
        async with self.getTestCoreWithPkg() as core:
            ...
            expected = [
                {"form": "inet:fqdn", "valu": "ncsi.4-c-0004.c-msedge.net"},
                {"form": "inet:fqdn", "valu": "time2.windows.com"},
            ]
    ...
    async def test_addStaticDomains_NoCreateSinceNoTag(self):
        """
