...
class Module_privsep_Tests(t_utils.TestUtils):
    ...
    async def test_getSubmissionFileTree_Raises_BadArg(self):
        """
        ...
        async with self.getTestCoreWithPkg() as core:
            q = """
                ...
                $inp = $lib.null
                return($mod.getSubmissionFileTree($inp))
                """
    ...
    async def test_getSubmissionFileTree_Raises_NeedConfValu_for_no_api_host(self):
        """
    ...
    async def test_getSubmissionFileTree_Raises_NeedConfValu_for_no_api_creds(self):
        """
    ...
    async def test_getSubmissionFileTree_resultsInCache(self):
        """
        Validate results are returned when already in cache
        """
        async with self.getTestCoreWithPkg() as core:
            ...
            q = """ 
                ...
                return($mod.getSubmissionFileTree($sid))
                """

            opts = {
                "vars": {
                    "api_result": "val-in-cache",
                }
            }
